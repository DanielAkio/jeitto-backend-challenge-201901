...
A aplicação está hospedada na plataforma Heroku, para ter acesso ao mesmo [clique aqui](https://jeitto.herokuapp.com/).

Para visualizar a documentação dos metodos da API [clique aqui](https://documenter.getpostman.com/view/11794083/SzzobGC7).
